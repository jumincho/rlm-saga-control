...
RUN_ROOT="${1:-/disk/chojm/experiments/rlm_saga_v1_feedback_v7_13_full_$(date +%Y%m%d_%H%M%S)}"
CONFIG_PATH="${2:-exp/config/experiment_feedback_v7_13.yaml}"
...
run_stage "stage_feedback_v7_13_smoke" "v7_13_smoke"
run_stage "stage_feedback_v7_13_debug" "v7_13_debug"
run_stage "stage_feedback_v7_13_boundary_dev" "v7_13_boundary_dev"
run_stage "stage_feedback_v7_13_boundary_test_v8" "v7_13_boundary_test_v8"
