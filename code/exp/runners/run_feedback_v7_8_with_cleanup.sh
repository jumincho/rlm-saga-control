...
RUN_ROOT="${1:-/disk/chojm/experiments/rlm_saga_v1_feedback_v7_8_full_$(date +%Y%m%d_%H%M%S)}"
CONFIG_PATH="${2:-exp/config/experiment_feedback_v7_8.yaml}"
...
run_stage "stage_feedback_v7_8_smoke" "v7_8_smoke"
run_stage "stage_feedback_v7_8_debug" "v7_8_debug"
run_stage "stage_feedback_v7_8_boundary_dev" "v7_8_boundary_dev"
run_stage "stage_feedback_v7_8_boundary_test" "v7_8_boundary_test"
run_stage "stage_feedback_v7_8_boundary_test_v2" "v7_8_boundary_test_v2"
run_stage "stage_feedback_v7_8_boundary_test_v3" "v7_8_boundary_test_v3"
