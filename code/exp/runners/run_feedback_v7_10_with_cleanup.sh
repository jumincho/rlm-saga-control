...
RUN_ROOT="${1:-/disk/chojm/experiments/rlm_saga_v1_feedback_v7_10_full_$(date +%Y%m%d_%H%M%S)}"
CONFIG_PATH="${2:-exp/config/experiment_feedback_v7_10.yaml}"
...
run_stage "stage_feedback_v7_10_smoke" "v7_10_smoke"
run_stage "stage_feedback_v7_10_debug" "v7_10_debug"
run_stage "stage_feedback_v7_10_boundary_dev" "v7_10_boundary_dev"
run_stage "stage_feedback_v7_10_boundary_test" "v7_10_boundary_test"
run_stage "stage_feedback_v7_10_boundary_test_v2" "v7_10_boundary_test_v2"
run_stage "stage_feedback_v7_10_boundary_test_v3" "v7_10_boundary_test_v3"
run_stage "stage_feedback_v7_10_boundary_test_v4" "v7_10_boundary_test_v4"
run_stage "stage_feedback_v7_10_boundary_test_v5" "v7_10_boundary_test_v5"
